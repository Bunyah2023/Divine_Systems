...
public class ClaseDao {
    ...
    static {
        try {
            ...
            config.setJdbcUrl("jdbc:mysql://sidex.ca9j43mxxj9t.us-east-1.rds.amazonaws.com:3306/SIDEX"); // Verifica que esta URL sea correcta
            config.setUsername("admin"); // Verifica el nombre de usuario
            config.setPassword("#$BybeDeby8484$#"); // Verifica la contraseña
